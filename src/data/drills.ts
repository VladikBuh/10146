...
export const drills: Drill[] = [
  {
    ...
    duration: '10 min',
    difficulty: 'Medium',
    image: require('../assets/tactical-formations-quick-passing-triangle.png'),
    paragraphs: [
  ...
  },
  {
    ...
    title: 'First Touch Gates',
    category: 'Field Player',
    shortDescription: 'Develop control in tight spaces',
    duration: '12 min',
    difficulty: 'Easy',
    image: require('../assets/tactical-formations-first-touch-gates.png'),
    paragraphs: [
  ...
  },
  {
    ...
    title: 'One-Two Combination Drill',
    category: 'Field Player',
    shortDescription: 'Practice fast passing combinations',
    duration: '12 min',
    difficulty: 'Medium',
    image: require('../assets/tactical-formations-one-two-combination-drill.png'),
    paragraphs: [
  ...
  },
  {
    ...
    title: 'Four-Corner Possession',
    category: 'Field Player',
    shortDescription: 'Improve awareness and ball retention',
    duration: '15 min',
    difficulty: 'Medium',
    image: require('../assets/tactical-formations-four-corner-possession.png'),
    paragraphs: [
  ...
  },
  {
    ...
    duration: '18 min',
    difficulty: 'Hard',
    image: require('../assets/tactical-formations-press-and-recover.png'),
    paragraphs: [
  ...
  },
  {
    ...
    title: 'Wall Pass Finishing',
    category: 'Field Player',
    shortDescription: 'Combine movement with accurate finishing',
    duration: '15 min',
    difficulty: 'Medium',
    image: require('../assets/tactical-formations-wall-pass-finishing.png'),
    paragraphs: [
  ...
  },
  {
    ...
    title: 'Direction Change Dribble',
    category: 'Field Player',
    shortDescription: 'Improve dribbling and quick turns',
    duration: '10 min',
    difficulty: 'Easy',
    image: require('../assets/tactical-formations-direction-change-dribble.png'),
    paragraphs: [
  ...
  },
  {
    ...
    title: 'Three-Zone Transition Game',
    category: 'Field Player',
    shortDescription: 'Train fast attacking transitions',
    duration: '15 min',
    difficulty: 'Hard',
    image: require('../assets/tactical-formations-three-zone-transition-game.png'),
    paragraphs: [
  ...
  },
  {
    ...
    duration: '10 min',
    difficulty: 'Medium',
    image: require('../assets/tactical-formations-goalkeeper-reaction-saves.png'),
    paragraphs: [
  ...
  },
  {
    ...
    title: 'Low Save Technique',
    category: 'Goalkeeper',
    shortDescription: 'Practice safe low diving saves',
    duration: '12 min',
    difficulty: 'Medium',
    image: require('../assets/tactical-formations-low-save-technique.png'),
    paragraphs: [
  ...
  },
  {
    ...
    title: 'Goalkeeper Distribution Targets',
    category: 'Goalkeeper',
    shortDescription: 'Improve accurate throws and passes',
    duration: '15 min',
    difficulty: 'Easy',
    image: require('../assets/tactical-formations-goalkeeper-distribution-targets.png'),
    paragraphs: [
  ...
  },
  {
    ...
    title: 'Close-Range Goalkeeper Duel',
    category: 'Goalkeeper',
    shortDescription: 'Develop positioning in one-on-one situations',
    duration: '12 min',
    difficulty: 'Hard',
    image: require('../assets/tactical-formations-close-range-goalkeeper-duel.png'),
    paragraphs: [
...
export const buildDrillShareMessage = (drill: Drill) =>
  `${drill.title} (${drill.category}) — ${
    drill.shortDescription
  }.\n\n${drill.paragraphs.join('\n\n')}`;
