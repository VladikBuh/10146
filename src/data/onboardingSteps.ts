...
export const onboardingSteps: OnboardingStep[] = [
  {
    image: require('../assets/guide-trainer-onboard1.png'),
  ...
  {
    image: require('../assets/guide-trainer-onboard2.png'),
  ...
  {
    image: require('../assets/guide-trainer-onboard3.png'),
  ...
  {
    image: require('../assets/guide-trainer-onboard4.png'),
