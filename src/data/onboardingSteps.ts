...
export const onboardingSteps: OnboardingStep[] = [
  {
    image: require('../assets/board-dribblo-onboard1.png'),
  ...
  {
    image: require('../assets/board-dribblo-onboard2.png'),
  ...
  {
    image: require('../assets/board-dribblo-onboard3.png'),
  ...
  {
    image: require('../assets/board-dribblo-onboard4.png'),
